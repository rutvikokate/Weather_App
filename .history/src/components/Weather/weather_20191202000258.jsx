                    ...
                    <div className="column right">
                       ...
                       <div className="columns weather-bar">
                        ...
                        <div className="  description ">
                            ...
                            <p><span className="heading" style={{color:'orange'}}><i className="wi wi-sunrise"/> sunrise: </span>{props.sunrise?<span>{props.sunrise}</span>:<span>-</span>}</p>
                            <p><span className="heading"  style={{color:'darkblue'}}><i className="wi wi-moonrise is-size-1" /> sunset: </span>{props.sunset?<span>{props.sunset}</span>:<span>-</span>}</p>
                            </div>
                        </div>
                    </div>
                    </div>
