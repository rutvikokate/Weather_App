                    ...
                    <div className="column right">
                       ...
                       <div className="columns weather-bar">
                        ...
                        <div className="  description ">
                            ...
                            <p><span className="heading" style={{color:'yellow'}}>sunrise: </span>{props.sunrise?<span>{props.sunrise}</span>:<span>-</span>}</p>
                            <p><span className="heading">sunset: </span>{props.sunset?<span>{props.sunset}</span>:<span>-</span>}</p>
                            </div>
                        </div>
                    </div>
                    </div>
