    ...
    return (
        <div>
          <div>
            ...
            <div>{this.this.props.error?this.error():null}</div>
                ...
                <div className="columns">
                    ...
                    <div className="column is-one-third left">
                        <div className="box">
                            ...
                            <form action="" onSubmit={this.this.props.loadweather}>
                    ...
                    <div className="column right">
                       ...
                       {this.props.city?<h1 className="title is-3">Weather in {this.this.props.city} </h1>:<h1 className="title is-3" style={{color:'#e7e7e7'}}>City,Country</h1>}
                       <hr/>
                       <div className="columns weather-bar">
                            <div className="column is-one-third" style={{background:''}}>
                            <div className="field is-grouped is-grouped-centered">
                            <h1 className="title is-1">
                                {this.this.props.weatherIcon?<img  className="image is-110x110" src={`http://openweathermap.org/img/wn/${this.this.props.weatherIcon}@2x.png`} alt=""/>:<span>-</span>}
                            </h1>
                            </div>
                            </div>
