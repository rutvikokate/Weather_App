                    ...
                    <div className="column right">
                       ...
                       <div className="columns weather-bar">
                        ...
                        <div className="  description ">
                            ...
                            <div className="right">
                            <span className="icon"><i className="wi wi-thunderstorm"></i></span>
                            <p><span className="heading" style={{color:'orange'}}>sunrise: </span>{props.sunrise?<span>{props.sunrise}</span>:<span>-</span>}</p>
                            <p><span className="heading"  style={{color:'darkblue'}}>sunset: </span>{props.sunset?<span>{props.sunset}</span>:<span>-</span>}</p>
                            </div>
                        </div>
                    </div>
                    </div>
