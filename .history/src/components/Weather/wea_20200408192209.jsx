...
export class Weather2 extends Component {
    ...
    rendersuggestions(){
        ...
        return(
            <ul>
              {suggestion.map((item)=><li className="tag is-medium" style={{cursor:'pointer'}}onClick={()=>this.suggestionselected(item)}>{item}</li>)}
          </ul>
        );
    }
                    ...
                    <div className="column is-one-third left">
                        <div className="box">
                            ...
                            <div className="field is-grouped is-grouped-centered">
                                <button className="button"   id="button" name="submit" ><span className="icon"><i class="fas fa-arrow-circle-down"></i></span><span>Get Weather</span></button>
                            </div>
                            </form>
                        </div>
