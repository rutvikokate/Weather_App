                    ...
                    <div className="column right">
                       ...
                       <div className="columns weather-bar">
                        ...
                        <div className="  description ">
                            ...
                            <p><span className="heading" style={{color:'orange'}}><i className="wi wi-sunrise is-size-5"/> sunrise: </span>{props.sunrise?<span>utcString({props.sunrise})</span>:<span><i className="wi wi-na is-size-4"/></span>}</p>
