                    ...
                    <div className="column right">
                       ...
                       <div className="columns weather-bar">
                            ...
                            <h1 className="title is-1">
                                {props.weatherIcon?<img  className="image is-110x110" src={`http://openweathermap.org/img/wn/${props.weatherIcon}@2x.png`} alt=""/>:<span><i className="wi wi-na is-size-4"/></span>}
                            </h1>
                            </div>
                            </div>
                                ...
                                <div className="content">
                                    <nav className="level is-mobile">
                                        <div className="level-item has-text-centered">
                                            ...
                                            {props.temp_celcius?<p className="title">{props.temp_celcius}&deg;C</p>:<p className="title"><i className="wi wi-na is-size-4"/></p>}
                                            </div>
                                        ...
                                        <div className="level-item has-text-centered">
                                            ...
                                            {props.temp_min?<p className="title">{props.temp_min}&deg;C</p>:<p className="title"><i className="wi wi-na is-size-4"/></p>}
                                            </div>
                                        </div>
                                        <div className="level-item has-text-centered">
                                            <div>
