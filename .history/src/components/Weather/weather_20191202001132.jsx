                    ...
                    <div className="column right">
                       ...
                       <div className="columns weather-bar">
                        ...
                        <div className="  description ">
                            <div className="left">
                            <p><span className="heading"><i className="wi wi-strong-wind is-size-5"/> wind speed: </span>{props.wind_speed?<span>{props.wind_speed} m/s</span>:<i className="wi wi-na is-size-5"/>}</p> 
                            ...
                            <p><span className="heading" style={{color:'orange'}}><i className="wi wi-sunrise is-size-5"/> sunrise: </span>{props.sunrise?<span>{props.sunrise}</span>:<span>-</span>}</p>

                            <p><span className="heading" style={{color:'darkblue'}}><i className="wi wi-moonrise is-size-5"/> sunset: </span>{props.sunset?<span>{props.sunset}</span>:<span>-</span>}</p>
