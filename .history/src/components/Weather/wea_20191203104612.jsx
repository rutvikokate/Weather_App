                    ...
                    <div className="column right">
                       ...
                       <div className="columns weather-bar">
                        ...
                        <div className="  description ">
                            <div className="left">
                            <p><span className="heading has-text-info"><i className="wi wi-strong-wind is-size-5"/> wind speed: </span>{this.props.wind_speed?<span>{this.props.wind_speed} m/s</span>:<i className="wi wi-na is-size-4"/>}</p> 
