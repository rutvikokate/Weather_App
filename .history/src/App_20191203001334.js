...
export class App extends Component {
  ...
  getdata=async()=>{
    ...
    this.setState({
        countries:this.getindex(Object.keys(response)),
        cities:(Object.values(response)[64])
    })
  ...
  getindex(countries){
    let index=-1;
    let val=this.state.countries;
    var filtered=countries.find(function(item,i){
      if(item.name===val){
        index=i;
        return i;
      }
